...
public class MyKMeansPlusPlusClusterer<T extends Clusterable> extends
    ...
    public CentroidComputer<T> getCentroidComputer() {
	return centroidComputer;
    }

    public void setCentroidComputer(CentroidComputer<T> centroidComputer) {
    ...
    private T getPointFromLargestVarianceCluster(
	    final Collection<CentroidCluster<T>> clusters)
	    throws ConvergenceException {
